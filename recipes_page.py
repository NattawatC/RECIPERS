...
"border-bottom-right-radius: 20px")
        ...
        self.logo_recipe.setPixmap(QPixmap(u"img/logo_recipe.png"))
        ...
        self.bg_recipes_page.setPixmap(QPixmap(u"img/bg_recipe.png"))
...
"background-color: transparent;")
        ...
        self.nav_recipe_logo.setPixmap(QPixmap(u"img/recipe-book.png"))
...
"background-color: transparent;")
        ...
        self.nav_bake_logo.setPixmap(QPixmap(u"img/bake.png"))
...
"background-color: transparent;")
        ...
        self.nav_fav_logo.setPixmap(QPixmap(u"img/favorite.png"))
...
"background-color: #f6f6f6")
        ...
        self.search_logo.setPixmap(QPixmap(u"img/loupe.png"))
...
"border: none")
        self.create_logo.setPixmap(QPixmap(u"img/grill.png"))
...
"border: none")
        ...
        self.create_logo_2.setPixmap(QPixmap(u"img/favorite2.png"))
...
"")
        ...
        self.card_img.setPixmap(QPixmap(u"img/BBQ.png"))
